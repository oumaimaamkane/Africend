...
class InvcPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Invc  $invc
     * @return bool
     */
    public function view(User $user, Invc $invc): bool
    {
     ...
     * @return bool
     */
    public function update(User $user, Invc $invc): bool
    {
     ...
     * @return bool
     */
    public function delete(User $user, Invc $invc): bool
    {
     ...
     * @return bool
     */
    public function forceDelete(User $user, Invc $invc): bool
    {
     ...
     * @return bool
     */
    public function restore(User $user, Invc $invc): bool
    {
     ...
     * @return bool
     */
    public function replicate(User $user, Invc $invc): bool
    {
